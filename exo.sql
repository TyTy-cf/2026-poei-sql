...
WHERE brands.label = "Renault"
  ...
  AND listings.mileage < 100000 LIMIT 20;
...
WHERE brands.label = "Renault"
  ...
  AND listings.price <= 9000 LIMIT 20;
...
SELECT CONCAT(UPPER(sellers.first_name), " ", UPPER(sellers.last_name)) AS Nom,
       COUNT(*)
